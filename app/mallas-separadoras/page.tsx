...
const description="Divisiones metálicas y mallas separadoras para bodegas, galpones, plantas y espacios operacionales. Evaluación según metros, altura, accesos y soporte existente.";
...
const faqs:readonly CommercialFaq[]=[
 {q:"¿Qué información necesito para cotizar una malla separadora?",a:"Metros lineales aproximados, altura, ubicación de puertas o pasos y fotografías del soporte existente permiten hacer una primera evaluación. Un croquis o layout ayuda cuando está disponible."},
 {q:"¿Una malla separadora sirve automáticamente como resguardo de maquinaria?",a:"No. Si la división forma parte de un resguardo de maquinaria o de una exigencia normativa, esas condiciones deben estar definidas y validadas por el proyecto antes de fabricar. Una división genérica no se presenta como certificación del sistema completo."},
 {q:"¿Se pueden incorporar puertas o accesos?",a:"Sí, pueden evaluarse puertas y pasos dentro de la división. Su cantidad, posición, dimensiones y alcance se confirman en la cotización vigente."},
];
const jsonLd=buildCommercialServiceJsonLd({path:"/mallas-separadoras",name:"Mallas separadoras metálicas para bodegas e industria",description,faqs});

export default function Page(){return <main className="v5-editorial-page theme-product" data-sgeo-owner="mallas-separadoras">
  <script type="application/ld+json" dangerouslySetInnerHTML={{__html:JSON.stringify(jsonLd)}}/>
  <section className="rinon-commercial-hero"><div className="container rinon-commercial-hero-grid"><div><div className="v2-eyebrow">MALLAS SEPARADORAS · DIVISIONES INTERIORES</div><h1>Divide el espacio sin perder lectura del recinto.</h1><p>Fabricamos divisiones y paños metálicos para bodegas, galpones y otros espacios interiores. El sistema se define según metros, altura, accesos, soporte existente y función del proyecto.</p><div className="v2-actions"><Link className="v2-btn orange" data-event="quote_start" data-cta-location="mallas_hero" href="/cotizar?category=cierres&detail=mallas_separadoras">Cotizar mallas separadoras</Link><WhatsAppCTA category="cierres" location="mallas_hero" label="Hablar por WhatsApp" className="v2-btn outline"/><Link className="v2-btn outline" href="/cierres-perimetrales">Ver cierres</Link></div><div className="v2-kickers"><span>Metros lineales</span><span>Altura</span><span>Puertas / accesos</span><span>Soporte existente</span></div></div><CommercialEvidencePanel title="PARA UBICAR LA DIVISIÓN" items={heroEvidence} note="Si la separación forma parte de un resguardo de maquinaria o requisito normativo, esas condiciones deben venir definidas y validadas por el proyecto."/></div></section>
  ...
  <section id="faq" className="v2-solution-section soft"><div className="container"><div className="section-head"><div><div className="v2-eyebrow">PREGUNTAS FRECUENTES</div><h2>Alcance y uso antes de fabricar.</h2></div><p>La función de la separación define qué información debe venir validada por el proyecto y qué puede resolver RINON dentro de la fabricación.</p></div><div className="faq-grid">{faqs.map(faq=><details key={faq.q}><summary>{faq.q}</summary><p>{faq.a}</p></details>)}</div></div></section>

  <section className="v2-final-cta"><div className="container"><div><div className="v2-eyebrow">TU ESPACIO</div><h2>¿Cuántos metros necesitas separar?</h2><p>Envía layout, croquis, fotos, altura y ubicación del proyecto.</p></div><div className="v2-actions"><Link className="v2-btn orange" data-event="quote_start" data-cta-location="mallas_footer" href="/cotizar?category=cierres&detail=mallas_separadoras">Cotizar división</Link><WhatsAppCTA category="cierres" location="mallas_footer" label="Hablar por WhatsApp" className="v2-btn outline"/></div></div></section>
</main>}
