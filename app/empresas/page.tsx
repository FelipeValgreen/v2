...
const buyers=[
  ...
  ["OPERACIONES", "Necesita resolver una función", "Uso real, restricciones, ubicación, mantenimiento y continuidad operacional."],
  ["OBRA / TERRENO", "Necesita coordinar fabricación y montaje", "Medidas, accesos, secuencia, interferencias y condiciones del sitio."],
  ["ADMINISTRACIÓN", "Necesita trazabilidad del requerimiento", "Qué se pidió, qué se cotizó, qué cambió y qué incluye finalmente el alcance."],
] as const;
...
export default function Page(){return <main className="v5-editorial-page rinon-enterprise-page" data-sgeo-owner="empresas">
  ...
  <section className="v2-solution-section"><div className="container"><div className="section-head"><div><div className="v2-eyebrow">ENTORNOS DE COMPRA</div><h2>Lo que se fabrica cambia según la operación.</h2></div><p>La misma capacidad de taller puede resolver necesidades distintas. Lo importante es definir uso, cantidad, destino y condiciones del proyecto.</p></div><div className="v2-sector-grid"><article><span>01</span><h3>Construcción y obra</h3><p>Cierres, estructuras, soportes, accesos y piezas asociadas a una habilitación o frente de trabajo.</p><small>CLAVE · medidas · secuencia · terreno</small></article><article><span>02</span><h3>Industria y mantenimiento</h3><p>Reparaciones, bases, protecciones, bastidores y fabricaciones para resolver una necesidad operacional concreta.</p><small>CLAVE · función · interferencias · continuidad</small></article><article><span>03</span><h3>Bodegas y logística</h3><p>Equipamiento, divisiones, cierres y elementos repetibles para ordenar o habilitar espacios.</p><small>CLAVE · uso · espacio · cantidad</small></article><article><span>04</span><h3>Instituciones y faenas</h3><p>Camas, camarotes, lockers y otros productos cuando cantidad, destino y entrega son parte central de la compra.</p><small>CLAVE · volumen · destino · fecha</small></article></div></div></section>

  <section className="v2-capabilities"><div className="container v2-capabilities-grid"><div><div className="v2-eyebrow">CÓMO AVANZA</div><h2>Una compra ordenada desde el primer contacto.</h2><p>Primero entendemos lo que se necesita. Después definimos qué falta confirmar para convertirlo en una propuesta fabricable y coordinable.</p></div><div className="v2-capability-list"><div><span>01</span><strong>Necesidad</strong><em>CONTEXTO</em></div><div><span>02</span><strong>Revisión</strong><em>FACTIBILIDAD</em></div><div><span>03</span><strong>Cotización</strong><em>ALCANCE</em></div><div><span>04</span><strong>Coordinación</strong><em>PROYECTO</em></div><div><span>05</span><strong>Fabricación y entrega</strong><em>EJECUCIÓN</em></div></div></div></section>
