...
<section id="resumen" className="v2-solution-hero"><div className="container v2-solution-hero-grid"><div><div className="v2-eyebrow">REJAS METÁLICAS</div><h1>Rejas metálicas a medida.</h1><p>Protección, acceso y lenguaje del lugar deben resolverse juntos. Una fotografía y medidas aproximadas suelen ser suficientes para iniciar la evaluación.</p><div className="v2-actions"><Link className="v2-btn orange" data-event="quote_start" data-cta-location="hero" href="/cotizar?category=cierres&detail=reja">Cotizar reja</Link><WhatsAppCTA category="cierres" location="hero" label="WhatsApp" className="v2-btn outline" /></div><div className="solution-meta-line"><span>Medidas aproximadas</span><span>Foto del lugar</span><span>Ubicación</span></div></div><TechnicalVisual kind="grille" label="Medidas + foto + ubicación." detail="Perímetro · apoyos · accesos · terminación" /></div></section>
