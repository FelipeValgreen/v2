...
<section id="cotizar" className="v2-final-cta"><div className="container"><div><div className="v2-eyebrow">COTIZACIÓN</div><h2>Una buena foto evita muchas suposiciones.</h2><p>Si puedes, envía una vista general y otra de los puntos donde debería apoyar o anclarse la reja.</p></div><div className="v2-actions"><Link className="v2-btn orange" data-event="quote_start" data-cta-location="rejas_footer" href="/cotizar?category=cierres&detail=reja">Enviar requerimiento</Link><WhatsAppCTA category="cierres" location="rejas_footer" label="Enviar fotos por WhatsApp" className="v2-btn outline" /></div></div></section>
</main>}
