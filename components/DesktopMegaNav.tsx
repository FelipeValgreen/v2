...
export function DesktopMegaNav(){
  ...
  return <div className="prd2-desktop-nav-shell" ref={wrapRef}>
    <nav className="prd2-desktop-nav" aria-label="Principal">
      ...
      <Link href={projectNavItem.href}>{projectNavItem.label}</Link>
      <Link href={companyNavItem.href}>{companyNavItem.label}</Link>
      ...
      <Link href={aboutNavItem.href}>{aboutNavItem.label}</Link>
    </nav>
