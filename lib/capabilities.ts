...
export const capabilities: Capability[] = [
  ...
  { key: "bending", label: "Doblez / plegado", status: "confirmed", publicClaim: "Doblez y conformado pueden formar parte del flujo de fabricación según pieza y requerimiento.", internalNote: "Proceso previamente confirmado por el owner; no publicar tonelaje, largo útil, espesores ni máquina sin respaldo específico." },
  ...
  { key: "drawing_review", label: "Revisión y generación de planos de fabricación", status: "conditional", publicClaim: "Los antecedentes y planos de fabricación pueden revisarse o desarrollarse como parte del alcance cuando corresponde.", internalNote: "Capacidad previamente comunicada por el owner. No confundir con ingeniería estructural, memoria de cálculo, firma profesional o certificación." },
  ...
  { key: "stainless", label: "Acero inoxidable", status: "confirmed", publicClaim: "Se pueden evaluar fabricaciones en acero inoxidable según geometría, proceso y requerimiento.", internalNote: "Material previamente confirmado por el owner. No publicar grados, espesores, terminaciones ni soldadura especializada sin cotización/evidencia específica." },
  { key: "aluminium", label: "Aluminio estructural", status: "confirmed", publicClaim: "Se pueden evaluar fabricaciones en aluminio estructural según geometría, proceso y requerimiento.", internalNote: "Material previamente confirmado por el owner. No publicar aleaciones, espesores, procesos de unión ni cargas sin respaldo específico." },
  {
    key: "powder_coating",
    label: "Pintura electrostática al horno",
    status: "validation_required",
    publicClaim: "Servicio sujeto a validación operacional antes de lanzamiento público.",
    internalNote: "Confirm operating status, useful dimensions, preparation, colors and batch logic.",
    launchEnv: "RINON_POWDER_COATING_LAUNCH_ENABLED",
  },
  {
    key: "sandblasting",
