...
const durable = new Set([
  "/", "/soluciones", "/camarotes", "/camarote-con-escritorio", "/cierres-perimetrales", "/mallas-3d", "/mallas-separadoras", "/rejas-metalicas", "/portones-metalicos", "/estructuras-metalicas", "/fabricacion-metalica", "/fabricaciones-especiales", "/equipamiento-metalico", "/pintura-electrostatica", "/cotizar", "/contacto", "/preguntas-frecuentes", "/politica-de-privacidad", "/politica-de-cookies", "/blog", "/empresas", "/proyectos", "/nosotros", "/recursos",
